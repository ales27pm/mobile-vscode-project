...
![MobileVSCode Interface](https://images.unsplash.com/photo-1527430253228-e93688616381?fit=crop&w=600&q=80)
...
![Architecture Diagram](https://placehold.co/600x400?text=Architecture+Diagram)
...
- **packages/editor** – a shared wrapper around the Monaco editor.
- **packages/react-native-monaco-editor** – React Native bindings for Monaco.
- **packages/shared** – GraphQL schema, generated types and utilities ensuring API consistency.
